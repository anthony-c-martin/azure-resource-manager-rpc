...
Many resource providers have resource name uniqueness requirements – usually defined as global (across regions of certain cloud) or local (within a region).  The following APIs provide a common pattern for verifying name availability.
